...
const Footer = () => {
  return (
    ...
    <Box display={'flex'} backgroundColor={'#FFBF23'} >
      ...
      <Box textAlign={"left"}>
      <Text ml={2}><strong> WEDU</strong></Text>
      <Text  ml={2} pb={"60px"}> Communicate. Collabrate. Create</Text>
      </Box>
      </Box>
    </Box>
    ...
    <Box display={'flex'} backgroundColor={'#FFBF23'} mb={19}   >
      ...
      <Box display={'flex'} backgroundColor={'#FFBF23'} pt={"50px"} pb={"60px"}>
      <Box ml={85} display={"flex"} >
      <Box textAlign={"left"}>
        <Text >Sales:</Text>
        <a href='https://mail.google.com/' target={"_blank"}><Text  _hover={{ color:'black' }}>info@mysite.com</Text></a>
      ...
      <Box textAlign={"left"}>
      <a href='https://www.linkedin.com/' target={"_blank"} ><Heading fontSize={20} _hover={{ color:'black' }} >LinkedIn</Heading></a>
        <br/>
        <a href='https://www.facebook.com/' target={"_blank"}><Heading fontSize={20} _hover={{ color:'black' }}>Facebook</Heading></a>
        <br/>
        <a href='https://www.youtube.com/' target={"_blank"}><Heading fontSize={20} _hover={{ color:'black' }}>YouTube</Heading></a>
        <br/>
      </Box>
      </Box>
      </Box>
      ...
      <Center display={'flex'}><Text color={'white'} pb={1}>© 2035 WeDu. Powered and secured by <Box as='u'>Wix </Box></Text></Center>
    </Box>
  )
  ...
  return(
    <InputGroup size="md">
      ...
      <InputRightElement width='4.5rem'>
        <Button h='2.5rem'  size='sm' backgroundColor={'black'} color={'white'}>
          Subscribe
        </Button>
      </InputRightElement>
    </InputGroup>
